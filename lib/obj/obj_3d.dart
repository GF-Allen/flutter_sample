...
class _ObjectPainter extends CustomPainter {
  ...
  Vector3 _normalVector3(Vector3 first, Vector3 second, Vector3 third) {
    ...
    return new Vector3((secondFirst.y * secondThird.z) - (secondFirst.z * secondThird.y),
        (secondFirst.z * secondThird.x) - (secondFirst.x * secondThird.z), (secondFirst.x * secondThird.y) - (secondFirst.y * secondThird.x));
  }
  ...
  List<dynamic> _drawFace(List<Vector3> verticesToDraw, List face) {
    ...
    var normalVector = _normalVector3(verticesToDraw[face[0] - 1], verticesToDraw[face[1] - 1], verticesToDraw[face[2] - 1]);
  ...
  bool shouldRepaint(_ObjectPainter old) =>
      old.object != object || old.angleX != angleX || old.angleY != angleY || old.angleZ != angleZ || old._zoomFactor != _zoomFactor;
}
