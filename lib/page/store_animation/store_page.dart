...
const shoes = [
  const Shoe(name: 'NIKE EPICT-REACT', price: 130.00, image: 'assets/store/store_1.png', color: Color(0xFF5574b9)),
  const Shoe(name: 'NIKE AIR-MAX', price: 130.00, image: 'assets/store/store_1.png', color: Color(0xFF52b8c3)),
  const Shoe(name: 'NIKE AIR-270', price: 150.00, image: 'assets/store/store_1.png', color: Color(0xFFE3AD9B)),
  const Shoe(name: 'NIKE EPICT-REACTII', price: 160.00, image: 'assets/store/store_1.png', color: Color(0xFF444547)),
];

const shoesBottom = [
  const Shoe(name: 'NIKE AIR-MAX', price: 170.00, image: 'assets/store/store_1.png'),
  const Shoe(name: 'NIKE AIR FORCE', price: 130.00, image: 'assets/store/store_1.png'),
];
              ...
              Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Transform.rotate(angle: vector.radians(18), child: Image.asset(shoe.image!)),
                    ),
                    Text(
                      shoe.name!,
                              ...
                              children: [
                                Transform(
                                  ...
                                  child: Stack(
                                    children: [
                                      Hero(
                                        tag: 'hero_background_${shoes[index].name}',
                                        child: Card(
                                          elevation: 6,
